...
/**
 * Native implementation of Preferences using singleton in-memory storage.
 * Storage persists for the lifetime of the application.
 * For true persistence across app restarts, platform-specific file storage would be needed.
 */
