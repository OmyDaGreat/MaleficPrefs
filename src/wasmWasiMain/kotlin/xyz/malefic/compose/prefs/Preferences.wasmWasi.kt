...
/**
 * WASM-WASI implementation using singleton in-memory storage.
 * For WASI environments with file system access, this could be enhanced with file-based storage.
 */
